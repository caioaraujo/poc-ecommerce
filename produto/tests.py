...
class TestModels(TestCase):
    ...
    def test_cria_produto(self):
        ...
        self.assertEqual(
            "2018-01-01 08:45", produto.data_criado.strftime("%Y-%m-%d %H:%M")
        )
        self.assertEqual(
            "2018-01-01 08:45", produto.data_alterado.strftime("%Y-%m-%d %H:%M")
        )
    ...
    def test_altera_produto(self):
        ...
        self.assertEqual(
            "2019-05-22 22:12", produto.data_alterado.strftime("%Y-%m-%d %H:%M")
        )
